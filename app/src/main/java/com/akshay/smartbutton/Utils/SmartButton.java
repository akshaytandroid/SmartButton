package com.akshay.smartbutton.Utils;
...
import com.akshay.smartbutton.R;
...
public class SmartButton extends Button {
    ...
    public SmartButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.smartButton, defStyle, 0);
        if (typedArray != null) {
            backgroundColor = typedArray.getColor(R.styleable.smartButton_backgroundColor, backgroundColor);
            shadowColor = typedArray.getColor(R.styleable.smartButton_shadowColor, shadowColor);
            corners = typedArray.getDimension(R.styleable.smartButton_corners, dipToPixels(getContext(), corners));
            pressedHeight = typedArray.getDimension(R.styleable.smartButton_pressedHeight, dipToPixels(getContext(), pressedHeight));
            normalHeight = typedArray.getDimension(R.styleable.smartButton_normalHeight, dipToPixels(getContext(), normalHeight));
            typedArray.recycle();
        }
